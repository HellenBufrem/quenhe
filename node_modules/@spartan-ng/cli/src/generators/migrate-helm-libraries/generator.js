...
const deleteFiles_1 = require("../base/lib/deleteFiles");
...
async function migrateHelmLibrariesGenerator(tree, options) {
    ...
    const config = await (0, config_1.getOrCreateConfig)(tree, { angularCli: options.angularCli });
...
async function detectLibraries(tree, importAlias) {
