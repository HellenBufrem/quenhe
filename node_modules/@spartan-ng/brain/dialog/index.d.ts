...
import { ConnectedPosition, FlexibleConnectedPositionStrategyOrigin, PositionStrategy, ScrollStrategy, OverlayPositionBuilder, ScrollStrategyOptions, ComponentType } from '@angular/cdk/overlay';
import * as _angular_core from '@angular/core';
import { StaticProvider, ElementRef, TemplateRef, Signal, WritableSignal, ValueProvider, InjectOptions, ViewContainerRef } from '@angular/core';
...
declare class BrnDialog<TResult = unknown, TContext extends Record<string, unknown> = Record<string, unknown>> {
    ...
    private readonly _dialogStateEffectRefs;
...
declare class BrnDialogRef<DialogResult = any> {
    ...
    readonly options: Signal<BrnDialogOptions | undefined>;
    constructor(_cdkDialogRef: DialogRef<DialogResult>, _open: WritableSignal<boolean>, state: Signal<BrnDialogState>, dialogId: number, _options?: BrnDialogOptions);
    updateOptions(options: Partial<BrnDialogOptions>): void;
