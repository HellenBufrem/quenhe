...
declare class BrnSelectTrigger {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<BrnSelectTrigger, "button[brnSelectTrigger]", never, { "id": { "alias": "id"; "required": false; "isSignal": true; }; }, {}, never, never, true, never>;
}
...
type SelectItemEqualToValue<T> = (itemValue: T, selectedValue: T | null) => boolean;
...
declare class BrnSelect<T> implements BrnSelectBase<T>, ControlValueAccessor {
    ...
    private readonly _triggerWrapper;
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<BrnSelect<any>, "[brnSelect]", never, { "disabled": { "alias": "disabled"; "required": false; "isSignal": true; }; "value": { "alias": "value"; "required": false; "isSignal": true; }; "isItemEqualToValue": { "alias": "isItemEqualToValue"; "required": false; "isSignal": true; }; "itemToString": { "alias": "itemToString"; "required": false; "isSignal": true; }; }, { "value": "valueChange"; }, ["_triggerWrapper", "items"], never, true, [{ directive: typeof i1.BrnFieldControl; inputs: {}; outputs: {}; }]>;
}
...
declare class BrnSelectTriggerWrapper {
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<BrnSelectTriggerWrapper, never>;
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<BrnSelectTriggerWrapper, "[brnSelectTriggerWrapper]", never, {}, {}, never, never, true, never>;
}
