...
class BrnToggleGroup {
    ...
    _multiple = computed(() => this.type() === 'multiple', ...(ngDevMode ? [{ debugName: "_multiple" }] : []));
    /** Value of the toggle group. */
    value = model(undefined, ...(ngDevMode ? [{ debugName: "value" }] : []));
    /** Emits when the value changes. */
    valueChange = output();
    /** Whether no button toggles need to be selected. */
    nullable = input(false, ...(ngDevMode ? [{ debugName: "nullable", transform: booleanAttribute }] : [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.17", ngImport: i0, type: BrnToggleGroup, decorators: [{
        ...
        }], propDecorators: { type: [{ type: i0.Input, args: [{ isSignal: true, alias: "type", required: false }] }], value: [{ type: i0.Input, args: [{ isSignal: true, alias: "value", required: false }] }, { type: i0.Output, args: ["valueChange"] }], valueChange: [{ type: i0.Output, args: ["valueChange"] }], nullable: [{ type: i0.Input, args: [{ isSignal: true, alias: "nullable", required: false }] }], disabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], change: [{ type: i0.Output, args: ["change"] }] } });
...
class BrnToggleGroupItem {
    ...
    id = input(`brn-toggle-group-item-${++BrnToggleGroupItem._uniqueId}`, ...(ngDevMode ? [{ debugName: "id" }] : []));
    ...
    _disabled = computed(() => this.disabled() || this._group?.disabled(), ...(ngDevMode ? [{ debugName: "_disabled" }] : []));
    ...
    _isOn = computed(() => this._state() === 'on', ...(ngDevMode ? [{ debugName: "_isOn" }] : []));
