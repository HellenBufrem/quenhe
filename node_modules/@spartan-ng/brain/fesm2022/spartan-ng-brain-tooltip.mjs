...
import { TemplateRef, inject, ViewContainerRef, input, effect, Directive, signal, ChangeDetectionStrategy, Component, InjectionToken, DestroyRef, ElementRef, Injector, Renderer2, booleanAttribute, linkedSignal, numberAttribute, output, computed, afterNextRender, runInInjectionContext } from '@angular/core';
...
class BrnTooltipStringTemplateOutlet {
    ...
    _lastContext;
    brnTooltipStringTemplateOutletContext = input(undefined, ...(ngDevMode ? [{ debugName: "brnTooltipStringTemplateOutletContext" }] : []));
    brnTooltipStringTemplateOutlet = input.required(...(ngDevMode ? [{ debugName: "brnTooltipStringTemplateOutlet" }] : []));
    ...
    }, ...(ngDevMode ? [{ debugName: "_viewEffect" }] : []));
...
class BrnTooltipContent {
    id = input(`brn-tooltip-${++uniqueId}`, ...(ngDevMode ? [{ debugName: "id" }] : []));
    state = signal('closed', ...(ngDevMode ? [{ debugName: "state" }] : []));
    _tooltipClass = signal('', ...(ngDevMode ? [{ debugName: "_tooltipClass" }] : []));
    _arrowClass = signal('', ...(ngDevMode ? [{ debugName: "_arrowClass" }] : []));
    _svgClass = signal('', ...(ngDevMode ? [{ debugName: "_svgClass" }] : []));
    _position = signal('top', ...(ngDevMode ? [{ debugName: "_position" }] : []));
    _tooltipText = signal(null, ...(ngDevMode ? [{ debugName: "_tooltipText" }] : []));
    ...
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.17", ngImport: i0, type: BrnTooltipContent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    /** @nocollapse */ static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "20.3.17", type: BrnTooltipContent, isStandalone: true, selector: "ng-component", inputs: { id: { classPropertyName: "id", publicName: "id", isSignal: true, isRequired: false, transformFunction: null } }, host: { attributes: { "role": "tooltip" }, properties: { "class": "_tooltipClass()", "attr.id": "id()", "attr.data-side": "_position()", "attr.data-state": "state()" } }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.17", ngImport: i0, type: BrnTooltipContent, decorators: [{
            type: Component,
            args: [{
...
class BrnTooltip {
    ...
    tooltipDisabled = input(false, ...(ngDevMode ? [{ debugName: "tooltipDisabled", transform: booleanAttribute }] : [{ transform: booleanAttribute }]));
    mutableTooltipDisabled = linkedSignal(this.tooltipDisabled, ...(ngDevMode ? [{ debugName: "mutableTooltipDisabled" }] : []));
    position = input(this._config.position ?? 'top', ...(ngDevMode ? [{ debugName: "position" }] : []));
    brnTooltip = input(null, ...(ngDevMode ? [{ debugName: "brnTooltip" }] : []));
    showDelay = input(this._config.showDelay, ...(ngDevMode ? [{ debugName: "showDelay", transform: numberAttribute }] : [{ transform: numberAttribute }]));
    hideDelay = input(this._config.hideDelay, ...(ngDevMode ? [{ debugName: "hideDelay", transform: numberAttribute }] : [{ transform: numberAttribute }]));
    show = output();
    hide = output();
    _tooltipText = computed(() => {
        ...
        return tooltipText;
    }, ...(ngDevMode ? [{ debugName: "_tooltipText" }] : []));
    constructor() {
        afterNextRender(() => {
    ...
    _show() {
        ...
        runInInjectionContext(this._injector, () => {
            ...
            }, ...(ngDevMode ? [{ debugName: "_ariaEffectRef" }] : []));
        });
        this.show.emit();
    }
    _hide() {
...
export { BrnTooltip, BrnTooltipContent, BrnTooltipImports, defaultOptions, injectBrnTooltipDefaultOptions, provideBrnTooltipDefaultOptions };
