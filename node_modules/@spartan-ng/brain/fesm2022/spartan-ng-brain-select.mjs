...
import { InjectionToken, Directive, inject, forwardRef, Injector, input, booleanAttribute, linkedSignal, model, computed, contentChild, ElementRef, contentChildren, signal, afterNextRender, effect, untracked, PLATFORM_ID, DestroyRef, TemplateRef, ViewContainerRef } from '@angular/core';
...
class BrnSelectTriggerWrapper {
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.17", ngImport: i0, type: BrnSelectTriggerWrapper, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.17", type: BrnSelectTriggerWrapper, isStandalone: true, selector: "[brnSelectTriggerWrapper]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.17", ngImport: i0, type: BrnSelectTriggerWrapper, decorators: [{
            type: Directive,
            args: [{ selector: '[brnSelectTriggerWrapper]' }]
        }] });
...
class BrnSelect {
    ...
    _triggerWrapper = contentChild(BrnSelectTriggerWrapper, ...(ngDevMode ? [{ debugName: "_triggerWrapper", read: ElementRef }] : [{
            read: ElementRef,
        }]));
    /** @internal The width of the trigger wrapper */
    triggerWidth = computed(() => {
        const element = this._triggerWrapper()?.nativeElement;
        if (!element)
            return null;
        return element.getBoundingClientRect().width || element.offsetWidth;
    }, ...(ngDevMode ? [{ debugName: "triggerWidth" }] : []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.17", ngImport: i0, type: BrnSelect, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { disabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "disabled", required: false }] }], value: [{ type: i0.Input, args: [{ isSignal: true, alias: "value", required: false }] }, { type: i0.Output, args: ["valueChange"] }], isItemEqualToValue: [{ type: i0.Input, args: [{ isSignal: true, alias: "isItemEqualToValue", required: false }] }], itemToString: [{ type: i0.Input, args: [{ isSignal: true, alias: "itemToString", required: false }] }], _triggerWrapper: [{ type: i0.ContentChild, args: [i0.forwardRef(() => BrnSelectTriggerWrapper), { ...{
                            read: ElementRef,
                        }, isSignal: true }] }], items: [{ type: i0.ContentChildren, args: [i0.forwardRef(() => BrnSelectItemToken), { ...{
                            descendants: true,
                        }, isSignal: true }] }] } });
...
class BrnSelectMultiple {
    ...
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.2.0", version: "20.3.17", type: BrnSelectMultiple, isStandalone: true, selector: "[brnSelectMultiple]", inputs: { disabled: { classPropertyName: "disabled", publicName: "disabled", isSignal: true, isRequired: false, transformFunction: null }, value: { classPropertyName: "value", publicName: "value", isSignal: true, isRequired: false, transformFunction: null }, isItemEqualToValue: { classPropertyName: "isItemEqualToValue", publicName: "isItemEqualToValue", isSignal: true, isRequired: false, transformFunction: null }, itemToString: { classPropertyName: "itemToString", publicName: "itemToString", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { value: "valueChange" }, providers: [
        ...
        ], queries: [{ propertyName: "_triggerWrapper", first: true, predicate: BrnSelectTriggerWrapper, descendants: true, read: ElementRef, isSignal: true }, { propertyName: "items", predicate: BrnSelectItemToken, descendants: true, isSignal: true }], hostDirectives: [{ directive: i1.BrnFieldControl }], ngImport: i0 });
}
...
class BrnSelectTrigger {
    ...
    _spartanInvalid = computed(() => this._select?.controlState?.()?.spartanInvalid, ...(ngDevMode ? [{ debugName: "_spartanInvalid" }] : []));
    constructor() {
    ...
    /** @nocollapse */ static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.17", type: BrnSelectTrigger, isStandalone: true, selector: "button[brnSelectTrigger]", inputs: { id: { classPropertyName: "id", publicName: "id", isSignal: true, isRequired: false, transformFunction: null } }, host: { attributes: { "role": "combobox", "aria-haspopup": "listbox", "type": "button" }, listeners: { "click": "open()", "keydown": "onKeyDown($event)" }, properties: { "id": "id()", "attr.aria-expanded": "_isExpanded()", "attr.data-placeholder": "_isPlaceholder() ? \"\" : null", "disabled": "_disabled()", "attr.aria-invalid": "_invalid?.() ? \"true\" : null", "attr.data-dirty": "_dirty?.() ? \"true\": null", "attr.data-touched": "_touched?.() ? \"true\" : null", "attr.data-matches-spartan-invalid": "_spartanInvalid?.() ? \"true\" : null" } }, ngImport: i0 });
}
