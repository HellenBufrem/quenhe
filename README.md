...
## 🔗 Links da Prototipagem (Atividade 4)
...
* **Documento de Design (SDD):** A arquitetura de dados (Diagrama ER), orquestração e Design Tokens estão detalhados no arquivo `docs/sdd.md`.
